...
Route::get('coba-reminderKuliah', 'BotController@cobaReminderKuliah')->name('coba.reminderKuliah');
Route::get('coba-reminderTambahan', 'BotController@cobaReminderTambahan')->name('coba.reminderTambahan');
